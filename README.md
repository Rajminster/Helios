...
Named after the Greek god of The Sun, Helius is the combination of a solar tracking C++ library, an Arduino 101 sketch, and an Android application which serves to track The Sun's movement so that it's always directly facing the device on which the software is running.
